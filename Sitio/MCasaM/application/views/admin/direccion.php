...
/**
* Página de direccion
* En esta página se muestrá los direcciones, este diseño es gracias a la librería de Grocery Crud
*
* @author Ernesto Rico Gutiérrez
* @package application/views/admin/
*
* @version 1.0.0
* Creado ‎‎‎‎‎viernes, ‎7‎ de ‎junio‎ de ‎2019, ‏‎11:17 am
* Última Modificación el 21/06/2019 a las 1:00 pm
*/
?>
