...
/**
* Página de repuesta
* En esta página se muestrá las repuestas, este diseño es gracias a la librería de Grocery Crud
*
* @author Ernesto Rico Gutiérrez
* @package application/views/admin/
*
* @version 1.0.0
* Creado ‎‎‎‎‎viernes, ‎7‎ de ‎junio‎ de ‎2019, ‏‎11:55 am
* Última Modificación el 21/06/2019 a las 1:05 pm
*/
?>
