...
/**
* Página de cliente
* En esta página se muestrá los clientes, este diseño es gracias a la librería de Grocery Crud
*
* @author Ernesto Rico Gutiérrez
* @package application/views/admin/
*
* @version 1.0.0
* Creado ‎‎‎‎‎jueves, ‎6‎ de ‎junio‎ de ‎2019, ‏‎10:57 pm
* Última Modificación el 21/06/2019 a las 12:55 pm
*/
?>
